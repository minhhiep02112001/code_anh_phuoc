...
<link rel="shortcut icon" href="{{ getImageThumb($config_website->favicon ?? '') }}" sizes="32x32">
<link rel="apple-touch-icon" href="{{ getImageThumb($config_website->favicon ?? '') }}" sizes="32x32">
