                ...
                <div class="card-header">
                    <div class="table-data__tool mb-0">
                        ...
                        <div class="table-data__tool-right">
                            <button type="button" data-action="{{ route('admin.language.store') }}" data-method="POST"
...
@push('scripts')
    ...
    <script>
        //setting url
        var url_ajax_list = window.APP_URL + "/admin/ajax/language";
        var url_ajax_edit = window.APP_URL + "/admin/language";
        // Dom Ready
