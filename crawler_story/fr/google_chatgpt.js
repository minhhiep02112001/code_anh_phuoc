...
async function getPost(offset = 0, limit = 100) {
    const query = `
        ...
        FROM st_post where  is_crawler_content=0 && is_status != 1 ORDER BY id ASC LIMIT ${limit} offset ${offset} `;
...
Tìm kiếm thông tin về brand restaurant france avis để đưa ra dữ liệu duy nhất (1), Search xong hãy viết lại dựa vào yêu cầu sau:
- Ngôn ngữ: tiếng Pháp 
