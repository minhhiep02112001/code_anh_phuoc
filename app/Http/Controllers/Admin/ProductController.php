...
class ProductController extends Controller
{
    ...
    public function ajax_load_data(Request $request)
    {
        ...
        if (!empty($list)) foreach ($list as $item) {
            ...
            $row['created_at'] = !empty($item->created_at) ? Carbon::parse($item->created_at)->format('Y-m-s H:i'): '';
            $row['updated_at'] = !empty($item->updated_at) ? Carbon::parse($item->updated_at)->format('Y-m-s H:i'): '';
            $row['publish_at'] = !empty($item->publish_at) ? Carbon::parse($item->publish_at)->format('Y-m-s H:i'): '';
    ...
    public function edit($id)
    {
        ...
        $data = [
            'action' => route('admin.product.update', ['post' => $id]),
            'method' => 'PUT',
            'row' => $row,
